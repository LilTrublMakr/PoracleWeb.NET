...
public partial class InitialPoracleWeb : Migration
{
    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table => table.PrimaryKey("PK_quick_pick_applied_states", x => x.id))
            .Annotation("MySQL:Charset", "utf8mb4");
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table => table.PrimaryKey("PK_quick_pick_definitions", x => x.id))
            .Annotation("MySQL:Charset", "utf8mb4");
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table => table.PrimaryKey("PK_user_geofences", x => x.id))
            .Annotation("MySQL:Charset", "utf8mb4");
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table => table.PrimaryKey("PK_webhook_delegates", x => x.id))
            .Annotation("MySQL:Charset", "utf8mb4");

        migrationBuilder.CreateIndex(
            name: "IX_quick_pick_applied_states_user_id_profile_no_quick_pick_id",
            table: "quick_pick_applied_states",
            columns: ["user_id", "profile_no", "quick_pick_id"],
            unique: true);
